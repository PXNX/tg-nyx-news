...
SOURCES = {
    **OWN_SOURCES,
    ...
    -1001594428146: Source('Werochna Rada', [
        '<a href="https://t.me/tv_rada">Телеканал Рада</a>'
    ], '🇺🇦'),
    -1001469021333: Source('DeepState', [
        '<a href="https://deepstateua.shop/">Магазин</a>🛑<a href="https://deepstateua.com/">Блог</a>🛑<a href="https://deepstatemap.live/">Мапа</a>🛑<a href="http://t.me/newsDeepStatebot">Написати нам</a>🛑<a href="https://help.deepstateua.com/">Звіти</a>🛑<a href="https://t.me/help_deepstateua">ЗСУHelp</a>'
    ], '🇺🇦'),
    ...
    -1001296487842: Source('Operativu ZSU', [
        '<a href="https://t.me/operativnoZSU">https://t.me/operativnoZSU</a>'
    ], '🇺🇦'),
    ...
    -1001318802260: Source('Anatolij Shtirlitz', [
        '@a_shtirlitz'
    ], '🇺🇦'),
    # -1001673614390: Source("Taras Hryhorovych", bias='🇺🇦'),
    -1001727181613: Source("NMFTE", bias='🇺🇦'),
    # -1001149657308: Source("Hueviy Charkiw", bias='🇺🇦'),
    -1001440814963: Source("Denys Smyhal", bias='🇺🇦'),
    ...
    -1001658917464: Source('KhersonNonFake', [
        '<strong>@kherson_non_fake</strong>',
    ...
    -1001326223284: Source('Rybar', [
        ...
        '@rybar\n\n<em>*Поддержать нас:</em><code> 4377 7278 0407 7977</code>'
        # todo: find a way to deal with optional spaces, maybe also find a way to clean up tags that sometimes exist and sometimes not^^
    ], '🇷🇺'),
    ...
    -1001082968817: Source('Verteidigungsministerium RU', [
        '@mod_russia',
        '<a href="https://t.me/heroesofZ">Подпишись на канал</a> |'
    ], '🇷🇺'),
    ...
    # -1001426514777: Source('SITREP', bias='🇷🇺'),
    -1001774541028: Source('Ravenstvo Media', bias='🇷🇺'),
    -1001632157043: Source('Katya Valya DNR', bias='🇷🇺'),
    -1001513431778: Source('Dwa Mayora', bias='🇷🇺'),
    #  -1001102909292: Source('Rus Criminal', bias='🇷🇺'),
    -1001215462939: Source('ANNA-News', [
        '@anna_news'
    ], '🇷🇺'),
    #  -1001033134963: Source('InoSMI', bias='🇷🇺'),
    -1001152463236: Source('Vorposte', [
        '@vorposte'
    ], '🇷🇺'),
    -1001074354585: Source('Milinfolive', [
        '@milinfolive'
    ], '🇷🇺'),
    -1001769400021: Source('RUSVARG', [
        '@rusvarg'
    ], '🇷🇺'),
    -1001583313036: Source('Erzengel Spetsnaz', [
        '<a href="https://t.me/rusich_army">Архангел Спецназа. Подписаться</a>.'
    ], '🇷🇺'),
    -1001283996236: Source('Res Ipsa Loquitur', bias='🇷🇺'),
    # -1001387701698: Source('Rosich', [
    #     '@rosich_ru',  # '<a href="https://t.me/rusich_army">Архангел Спецназа.</a>'
    # ], '🇷🇺'),
    ...
    -1001261746950: Source('AAF', [
        r'<a href="http://t.me/military_az"><strong>AАF</strong></a><strong> | </strong><a href="https://t.me/joinchat/TCl5uh3G0Mhx42Kd"><strong>Чат24/7</strong></a><strong> | </strong><a href="https://t.me/AslanAslanoff"><strong>Сотрудничество</strong></a>'
    ], '🇦🇿'),
    ...
    # Germany
    # -1001177424903: Source('Compact', [
    #    'Kostenlos abonnieren: t.me/CompactMagazin'
    # ], bias='🇩🇪🇷🇺'),

    # Iran
    -1001119518112: Source('Tagebuch eines iranischen Journalisten', bias='🇮🇷🇷🇺'),
